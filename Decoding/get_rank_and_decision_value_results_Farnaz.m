function [correct_class_decision_values, normalized_rank_results, rank_confusion_matrix] = get_rank_and_decision_value_results_Farnaz(YTe, classifier_labels, decision_values, create_rank_confusion_matrix)
...
YTe_unique_values=classifier_labels;
...
% % plot(the_ranks_all_test_points(iTestPoint, :))
% % hold on
% % plot(YTe_unique_values(the_ranks_all_test_points(iTestPoint, :)))
% figure
% plot(correct_class_decision_values)
% figure
%  plot(rank_confusion_matrix)   
%     
% figure
% imagesc(rank_confusion_matrix)
% 
% 
% %%
% figure
% plot(curr_rank_results2,'r')
% hold on
% plot(curr_rank_results,'b')
